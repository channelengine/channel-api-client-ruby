...
module ChannelEngineChannelApiClient
  class ChannelReturnRequest
    ...
    def hash
      [channel_order_no, merchant_order_no, channel_reference, key_is_merchant_order_no, key_is_merchant_product_no, lines, id, reason, customer_comment, merchant_comment, refund_incl_vat, refund_excl_vat, return_date].hash
    end
