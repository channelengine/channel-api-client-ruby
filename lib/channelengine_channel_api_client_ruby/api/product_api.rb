...
module ChannelEngineChannelApiClient
  class ProductApi
    ...
    def product_acknowledge_data_changes_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'channel_processed_changes_request']) 
    ...
    def product_get_data_changes_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SingleOfChannelProductChangesResponse' 
    ...
    def product_get_offer_changes_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CollectionOfChannelOfferResponse' 
