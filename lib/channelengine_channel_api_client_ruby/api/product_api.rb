...
module ChannelEngineChannelApiClient
  class ProductApi
    ...
    # @option opts [Integer] :page 
    # @option opts [Integer] :page_size 
    # @return [Array<(CollectionChangesOfChannelProductChangesResponse, Integer, Hash)>] CollectionChangesOfChannelProductChangesResponse data, response status code and response headers
    def product_get_data_changes_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CollectionChangesOfChannelProductChangesResponse'
